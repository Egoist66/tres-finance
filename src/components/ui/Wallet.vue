      ...
      <div class="wallet__head-info">
        ...
        >
          <g clip-path="url(#clip0_16_1826)">
            <rect width="24" height="24" fill="url(#pattern0_16_1826)" />
          </g>
          <defs>
            <pattern
              id="pattern0_16_1826"
              ...
              height="1"
            >
              <use xlink:href="#image0_16_1826" transform="scale(0.00520833)" />
            </pattern>
    ...
    <div class="wallet__body open">
      <table class="wallet__table w-full border-collapse border border-gray-400">
        <tr>
          ...
          <th>Network</th>
          <th>Current balance
            <button class="wallet__table-icon ml-2 text-gray-500 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><path d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0 -20Zm0 3a7 7 0 1 0 0 14 7 7 0 0 0 0 -14Zm0 3a3 3 0 1 0 0 6 3 3 0 0 0 0 -6Zm0 2.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0 -3Zm0 3a1 1 0 1 0 0 2 1 1 0 0 0 0 -2Zm0 2.5a.5.5 0 1 1 0 1 .5.5 0 0 1 0 -1Zm0 1a.5.5 0 1 1 0 1 .5.5 0 0 1 0 -1Zm0 1.5a.5.5 0 1 1 0 1 .5.5 0 0 1 0 -1Zm0 1a.5.5 0 1 1 0 1 .5.5 0 0 1 0 -1Zm0 1.5a.5.5 0 1 1 0 1 .5.5 0 0 1 0 -1Zm0 1a.5.5 0 1 1 0 1 .5.5 0 0 1 0 -1Zm0 1a.5.5 0 1 1 0 1 .5.5 0 0 1 0 -1Z"></path></svg>
            </button>
          </th>
        </tr>
        
        <tr :key="asset.id" v-for="asset in assets">
          <td class="px-4 text-center py-2 border-b border-gray-400">
          ...
          <td class="px-4 text-center py-2 border-b border-gray-400">
            ...
            <p>
              <button class="wallet__table-icon ml-2 text-gray-500 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out"></button>
        ...
        <tr class="wallet__table-info">
          <td class="px-4 py-2">
            ...
            <button class="wallet__table-icon ml-2 text-gray-500 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out">Summary</button>
          </td>
          <td class="px-4 py-2">
            <!-- <div class="wallet__table-wrapper-icon">
              <svg></svg>
